...
export default function BlogPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F3F5F8] px-6 py-16 md:px-12 lg:px-20">
      {/* Ambient glow */}
      ...
      <div className="relative z-10 mx-auto max-w-3xl">
        ...
        <section className="mb-14">
          <p className="text-base leading-[1.85] text-[#4E5F77]">
            First and foremost, a quick disclaimer: this is not a scientifically or psychologically grounded assessment. While I&apos;ve tried my best to make this framework as fair and unbiased as possible, please remember that the questions and ideologies behind this test were designed by a 22-year-old without a degree in music or psychology. Although I&apos;ve tested this with a few friends, there are no rigorous studies backing my methodology. Basically, what I&apos;m trying to say is, don&apos;t take this too seriously.
            <br />
            <br />
            That being said, music and psychology are both topics I care a lot about, and therefore I&apos;ve put a level of effort into making this test that I typically wouldn&apos;t do for other side projects. If you&apos;re curious about the philosophy, mechanics, and considerations behind the test, read on.
          </p>
        </section>
        {/* Intro */}
        <section className="mb-14">
        ...
        <section className="mb-14">
          ...
          <div className="flex flex-col gap-9">
            ...
            <div>
              <h3 className="mb-3 text-base font-bold text-[#1A2133]">
                Testing Impulse Over Ability
              </h3>
              <p className="text-base leading-[1.85] text-[#4E5F77]">
            ...
            <div>
              <h3 className="mb-3 text-base font-bold text-[#1A2133]">
                Eliminating the &ldquo;Right&rdquo; Answer
              </h3>
              <p className="text-base leading-[1.85] text-[#4E5F77]">
            ...
            <div>
              ...
              <p className="text-base leading-[1.85] text-[#4E5F77]">
                Your taste is shaped by exposure, environment, and social variables, and therefore, asking &ldquo;Do you like this song?&rdquo; about a popular track can introduce some positive or negative biases that I&apos;d prefer to avoid. Therefore, the majority of the test relies on questions without music, and the few songs present are relatively obscure tracks placed to capture your raw and unfiltered reaction.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-base leading-[1.85] text-[#4E5F77]">
                Bridging the gap between people with and without formal music training is extremely difficult and makes it hard to test certain things. A listener&apos;s ability to process complex music is heavily linked to their previous musical exposure, as well as certain psychological traits. To account for this, I&apos;ve tried to select reference tracks that are neither too simple nor overly complex.
              </p>
            </div>

            <div>
              <h3 className="mb-3 text-base font-bold text-[#1A2133]">
                A Note on Lyrics & Aesthetics
              </h3>
              <p className="text-base leading-[1.85] text-[#4E5F77]">
                Many people listen to music purely for the lyrics, the aesthetic, or the artist&apos;s persona. If you fall entirely into this group, your results here will likely be inaccurate and you probably didn&apos;t know how to respond to a lot of the questions. This scale is specifically designed to measure the function of music and how the actual sound interacts with your brain. Lyrics introduce an entirely new dimension that I didn&apos;t feel like I could capture easily.
              </p>
            </div>
        ...
        <section className="mb-14">
          ...
          <p className="mb-12 text-base leading-[1.85] text-[#4E5F77]">
            I want to provide a bit of intuition behind why I chose these four specific spectrums to measure how we experience music.
          </p>
          ...
          <div className="flex flex-col gap-14">
            ...
            <div>
              <div className="mb-4 flex items-center gap-3">
                ...
                <h3 className="text-lg font-black text-[#1A2133]">
                  Motivation: Vibes vs. Musicality
                </h3>
              </div>
            ...
            <div>
              ...
              <p className="mb-5 text-base leading-[1.85] text-[#4E5F77]">
                Testing this was harder than I anticipated. I originally planned to use jazz tracks, since the genre relies on unconventional chords and rhythms that still follow music theory. But I realized that listeners without prior exposure to jazz wouldn&apos;t hear surprise; their brains would just categorize it as dissonant noise, forcing them to lean heavily towards comfort by default. To account for this, I designed questions that test your tolerance for friction and novelty in more grounded ways.
              </p>
              <p className="text-base leading-[1.85] text-[#4E5F77]">
            ...
            <div>
              <div className="mb-4 flex items-center gap-3">
                ...
                <h3 className="text-lg font-black text-[#1A2133]">
                  Momentum: Immersion vs. Progression
                </h3>
              </div>
              <p className="mb-5 text-base leading-[1.85] text-[#4E5F77]">
        ...
        <section className="mb-14">
          ...
          <div className="rounded-xl border border-[#DDE4EE] bg-[#F8FAFC] px-6 py-5">
            <p className="text-sm leading-[1.75] text-[#4E5F77]">
              ...
              You are only graded on the battles you choose to fight. The engine adjusts on the fly, so your final percentages are an unbiased reflection of the choices you actually engaged with.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="text-base leading-[1.85] text-[#4E5F77]">
            I hope you&apos;ve found your results insightful and that this framework has opened your mind a bit more to the mechanics behind why we enjoy the music that we do.
          </p>
        </section>
